...
public sealed class ChatService : BackgroundService
{
    ...
    private readonly IOptionsMonitor<CauldronServerOptions> _opts;
    ...
    public ChatService(ILogger<ChatService> log, IOptionsMonitor<CauldronServerOptions> opts)
    {
        _log = log;
        _opts = opts;
    ...
    /// <summary>
    /// Public ingest path for messages typed by a player in their CauldronHud
    ...
    // ---------- Outbound drain (Lua -> CauldronServer) ----------
    ...
    // ---------- Inbound append (CauldronServer -> Lua) ----------
