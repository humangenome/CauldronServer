...
namespace Cauldron.Protocol.Tests;
...
public class ModFrameTests
{
    ...
    public void ModManifestResponse_with_multiple_required_mods()
    {
        ...
        round.ServerName.Should().Be("Cauldron — AdminTest");
    }
    ...
    public void Mod_frame_type_numbers_are_stable()
    {
        ...
        // manifests and CauldronServer audit logs. Don't renumber.
