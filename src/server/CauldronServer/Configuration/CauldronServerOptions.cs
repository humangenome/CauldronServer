namespace CauldronServer.Configuration;

public sealed class CauldronServerOptions
{
    /// <summary>
    ...
    /// Default false = Information. Can also be enabled via the CAULDRON_VERBOSE
    ...
    public string PipeName { get; set; } = @"Cauldron\default";
    ...
    /// <summary>
    /// Maximum upload size for snapshot import / restore. Witchspire worlds
    ...
    /// handshake + the native Cauldron.dll ApproveLogin hook. The game's stock
    ...
    /// Password enforcement routes through CauldronAuth.lua only (see
    /// <see cref="CauldronAuthPassword"/>). Lua, A2S, and native (CauldronPlugin.cpp)
    ...
    /// <summary>
    /// Password enforced by CauldronAuth.lua's K2_PostLogin hook for
    ...
    /// </summary>
    public string CauldronAuthPassword { get; set; } = "";

    public string ServerName { get; set; } = "";

    public string GameInstallRoot { get; set; } = @"C:\Cauldron\game";

    /// <summary>
    /// Optional direct path to the Witchspire executable. Leave empty to
    /// auto-detect supported Steam/Epic Win64 and Xbox WinGDK layouts under
    /// <see cref="GameInstallRoot"/>.
    /// </summary>
    public string GameExecutablePath { get; set; } = "";

    public string GameUserDir { get; set; } = @"C:\Cauldron\userdir";

    public string SaveDir { get; set; } = @"C:\Cauldron\saves";

    /// <summary>
    /// Optional path to a single-line file containing the PID of the game
    /// process this CauldronServer instance owns. Used by KillGame as a
    ...
    /// reports a slot count that doesn't match what CauldronServer hands out.
    /// </summary>
