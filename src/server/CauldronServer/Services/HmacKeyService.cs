...
/// IPC. Stored as 64-hex characters in <see cref="CauldronServerOptions.HmacKeyPath"/>.
...
public sealed class HmacKeyService
{
    ...
    public HmacKeyService(IOptions<CauldronServerOptions> options, ILogger<HmacKeyService> log)
    {
        ...
        else
        {
            ...
            log.LogWarning("Generated new HMAC key at {Path} — copy this to Cauldron.dll instance config", path);
        }
    }
